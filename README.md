See project WorkZoneOData4Samples for getting started with WorkZone OData4. It demonstrates basic setup and usage of OData4 from .Net 10 using Microsoft.OData.Client 9.0 and WorkZone.OData.Client.
